#include "ass5_20CS10003_20CS30063_translator.h"
...
void SymbolTable::print()
{
    ...
    cout << string(130, '-') << endl;
    cout << setw(20) << "Name" << setw(30) << "Type" << setw(20) << "Initial Value" << setw(20) << "Offset" << setw(20) << "Size" << setw(20) << "Child" << "\n" << endl;
    ...
    for (auto &map_entry : (this)->symbols)
    {
        ...
        fflush(stdout);
        cout << setw(30) << (map_entry.second.isFunction ? "function" : map_entry.second.type->toString());
